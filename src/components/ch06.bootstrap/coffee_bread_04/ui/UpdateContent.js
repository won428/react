        ...
        <div>
            ...
            <form action="#" onSubmit={SubmitedData}>
                ...
                <InputGroup className="custom-input-group">
                    ...
                    <Form.Control type="text" name ="name" value={formData.name} onChange={InputChange}></Form.Control>
                </InputGroup>
                <InputGroup className="custom-input-group">
                    <InputGroup.Text className ="input-group-text">가격</InputGroup.Text>
                    <Form.Control type="number" name ="price" value={formData.price} onChange={InputChange}></Form.Control>
                </InputGroup>
                <InputGroup className="custom-input-group">
                ...
                <InputGroup className="custom-input-group">
                    ...
                    <Form.Control type="text" name ="stock" value={formData.stock} onChange={InputChange}></Form.Control>
                </InputGroup>
                <InputGroup className="custom-input-group"> 
                    <InputGroup.Text className ="input-group-text">이미지 </InputGroup.Text>
                    <Form.Control type="text" name ="image" value={formData.image} onChange={InputChange}></Form.Control>
                </InputGroup>
                <InputGroup className="custom-input-group">
                    <InputGroup.Text className ="input-group-text" >설명</InputGroup.Text>
                    <Form.Control as = "textarea" name ="description" value={formData.description} onChange={InputChange}></Form.Control>
                </InputGroup>
